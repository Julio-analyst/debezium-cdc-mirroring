# CDC Pipeline Real-Time Statistics Monitor
...
function Get-ContainerHealthStatus {
    ...
    try {
        ...
        # Check tutorial-connect-1 separately
...
Write-Host "Source: PostgreSQL inventory (localhost:5432)" -ForegroundColor Gray
Write-Host "Target: PostgreSQL postgres (localhost:5433)" -ForegroundColor Gray
Write-Host "Topic: dbserver1.inventory.orders" -ForegroundColor Gray
Write-Host ("=" * 80) -ForegroundColor Gray

# Execute main monitoring functions (Points 1-7)
...
# Execute additional monitoring functions (Points 8-10)
Get-KafkaMessageAnalysis
Get-DatabaseMetrics
